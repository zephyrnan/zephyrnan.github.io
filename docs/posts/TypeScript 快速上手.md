...
str1 = 'hello'
str1 = new String('hello') // 报错：不能将 String 对象赋给 string 类型

let str2: String
str2 = 'hello'
str2 = new String('hello') // 无警告
...
```ts
// 明确地表示 a 的类型是 any —— 【显式的 any】
let a: any // 以下对 a 的赋值，均⽆警告
a = 100
a = '你好'
a = false

// 没有明确表示 b 的类型是 any，但 TS 主动推断出 b 是 any —— 隐式的 any
let b
// 以下对 b 的赋值，均⽆警告
b = 100
b = '你好'
...
function demo(): void {
	// 返回undefined合法
	return undefined
	// 以下返回均不合法（仅作演示，实际不能同时写这么多 return）
	// return 100
	// return false
	// return null
	// return []
...
class Person {
    ...
    // 这里使用参数属性的简写形式，直接在构造器参数上加修饰符即可声明并赋值
...
let ip1: PersonInterface<string>
let ip2: PersonInterface<number>
ip1 = { name: '张三', age: 18, extraInfo: '一个好人' }
ip2 = { name: '李四', age: 18, extraInfo: 250 }
