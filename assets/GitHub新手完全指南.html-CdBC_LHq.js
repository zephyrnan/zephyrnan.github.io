...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>⚠️ <strong>注意事项</strong>:</p><ul><li><strong>--global vs --local</strong>: <ul><li><code>--global</code>: 全局配置,对所有Git仓库生效</li><li><code>--local</code>: 仅对当前仓库生效(省略--global即为本地)</li></ul></li><li><strong>邮箱要匹配</strong>: 邮箱最好与GitHub注册邮箱一致,否则贡献记录可能不显示</li><li><strong>中文用户名</strong>: 支持中文,但建议使用英文避免兼容性问题</li><li><strong>查看特定配置</strong>: <code>git config user.name</code> 或 <code>git config user.email</code></li><li><strong>配置文件位置</strong>: <ul><li>全局: <code>~/.gitconfig</code> (Windows: <code>C:\\Users\\用户名\\.gitconfig</code>)</li><li>本地: <code>.git/config</code></li></ul></li></ul><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line"><span class="token comment"># 常见错误:邮箱设置错误</span></span>
<span class="line"><span class="token function">git</span> config <span class="token parameter variable">--global</span> user.email <span class="token string">&quot;email@example&quot;</span>  <span class="token comment"># ❌ 无效邮箱格式</span></span>
<span class="line"><span class="token function">git</span> config <span class="token parameter variable">--global</span> user.email <span class="token string">&quot;email@example.com&quot;</span>  <span class="token comment"># ✅ 正确</span></span>
<span class="line"></span>
<span class="line"><span class="token comment"># 为单个项目设置不同的用户信息</span></span>
<span class="line"><span class="token builtin class-name">cd</span> my-work-project</span>
<span class="line"><span class="token function">git</span> config <span class="token parameter variable">--local</span> user.email <span class="token string">&quot;work@company.com&quot;</span>  <span class="token comment"># 工作邮箱</span></span>
<span class="line"></span>
<span class="line"><span class="token builtin class-name">cd</span> <span class="token punctuation">..</span>/my-personal-project</span>
<span class="line"><span class="token function">git</span> config <span class="token parameter variable">--local</span> user.email <span class="token string">&quot;personal@gmail.com&quot;</span>  <span class="token comment"># 个人邮箱</span></span>
<span class="line"></span>
<span class="line"><span class="token comment"># 查看生效的配置</span></span>
<span class="line"><span class="token function">git</span> config <span class="token parameter variable">--list</span> --show-origin  <span class="token comment"># 显示每个配置的来源</span></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></blockquote><blockquote><p>🎯 <strong>实际应用场景</strong>:</p><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line"><span class="token comment"># 场景1:初次安装Git后的全局配置</span></span>
<span class="line"><span class="token function">git</span> config <span class="token parameter variable">--global</span> user.name <span class="token string">&quot;Zhang San&quot;</span></span>
<span class="line"><span class="token function">git</span> config <span class="token parameter variable">--global</span> user.email <span class="token string">&quot;zhangsan@example.com&quot;</span></span>
<span class="line"><span class="token function">git</span> config <span class="token parameter variable">--global</span> core.editor <span class="token string">&quot;code --wait&quot;</span>  <span class="token comment"># 设置默认编辑器为VSCode</span></span>
<span class="line"><span class="token function">git</span> config <span class="token parameter variable">--global</span> init.defaultBranch main  <span class="token comment"># 设置默认分支名为main</span></span>
<span class="line"></span>
<span class="line"><span class="token comment"># 场景2:工作电脑配置多个Git账户</span></span>
<span class="line"><span class="token comment"># 全局使用工作账户</span></span>
<span class="line"><span class="token function">git</span> config <span class="token parameter variable">--global</span> user.name <span class="token string">&quot;Work Name&quot;</span></span>
<span class="line"><span class="token function">git</span> config <span class="token parameter variable">--global</span> user.email <span class="token string">&quot;work@company.com&quot;</span></span>
<span class="line"></span>
<span class="line"><span class="token comment"># 个人项目使用个人账户</span></span>
<span class="line"><span class="token builtin class-name">cd</span> ~/personal-projects/my-blog</span>
<span class="line"><span class="token function">git</span> config <span class="token parameter variable">--local</span> user.name <span class="token string">&quot;Personal Name&quot;</span></span>
<span class="line"><span class="token function">git</span> config <span class="token parameter variable">--local</span> user.email <span class="token string">&quot;personal@gmail.com&quot;</span></span>
<span class="line"></span>
<span class="line"><span class="token comment"># 场景3:配置Git常用别名</span></span>
<span class="line"><span class="token function">git</span> config <span class="token parameter variable">--global</span> alias.st status  <span class="token comment"># git st = git status</span></span>
<span class="line"><span class="token function">git</span> config <span class="token parameter variable">--global</span> alias.co checkout  <span class="token comment"># git co = git checkout</span></span>
<span class="line"><span class="token function">git</span> config <span class="token parameter variable">--global</span> alias.br branch  <span class="token comment"># git br = git branch</span></span>
<span class="line"><span class="token function">git</span> config <span class="token parameter variable">--global</span> alias.cm <span class="token string">&quot;commit -m&quot;</span>  <span class="token comment"># git cm &quot;msg&quot;</span></span>
<span class="line"><span class="token function">git</span> config <span class="token parameter variable">--global</span> alias.last <span class="token string">&quot;log -1 HEAD&quot;</span>  <span class="token comment"># 查看最后一次提交</span></span>
<span class="line"></span>
<span class="line"><span class="token comment"># 场景4:配置中文文件名显示</span></span>
<span class="line"><span class="token function">git</span> config <span class="token parameter variable">--global</span> core.quotepath <span class="token boolean">false</span>  <span class="token comment"># 显示中文文件名而不是转义字符</span></span>
<span class="line"></span>
<span class="line"><span class="token comment"># 场景5:配置Windows/Linux换行符处理</span></span>
<span class="line"><span class="token comment"># Windows用户</span></span>
<span class="line"><span class="token function">git</span> config <span class="token parameter variable">--global</span> core.autocrlf <span class="token boolean">true</span></span>
<span class="line"><span class="token comment"># Linux/macOS用户</span></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></blockquote><h3 id="_4-配置-ssh-密钥-推荐" tabindex="-1"><a class="header-anchor" href="#_4-配置-ssh-密钥-推荐"><span>4. 配置 SSH 密钥（推荐）</span></a></h3><p><strong>为什么需要 SSH？</strong> 使用 SSH 可以避免每次推送代码时输入用户名和密码。</p><p><strong>生成 SSH 密钥</strong></p><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line"><span class="token comment"># 生成密钥（推荐 ed25519 算法，更短更安全；邮箱替换为你的 GitHub 邮箱）</span></span>
...
<span class="line"><span class="token comment"># 密钥保存在 ~/.ssh/id_ed25519.pub（公钥）和 ~/.ssh/id_ed25519（私钥）</span></span>
<span class="line"><span class="token comment"># 注意：公钥(.pub)可以分享，私钥绝对不能泄露给任何人</span></span>
<span class="line"></span>
<span class="line"><span class="token comment"># 如果系统较老不支持 ed25519，再退回用 RSA：</span></span>
<span class="line"><span class="token comment"># ssh-keygen -t rsa -b 4096 -C &quot;your_email@example.com&quot;</span></span>
...
<span class="line"><span class="token function">cat</span> ~/.ssh/id_ed25519.pub <span class="token operator">|</span> clip</span>
<span class="line"></span>
<span class="line"><span class="token comment"># macOS</span></span>
<span class="line"><span class="token function">cat</span> ~/.ssh/id_ed25519.pub <span class="token operator">|</span> pbcopy</span>
<span class="line"></span>
<span class="line"><span class="token comment"># Linux</span></span>
<span class="line"><span class="token function">cat</span> ~/.ssh/id_ed25519.pub</span>
...
<span class="line"></span>
<span class="line"><span class="token comment"># ✅ 正确做法：从所有历史记录中彻底移除文件</span></span>
<span class="line"></span>
<span class="line"><span class="token comment"># 方法一（官方推荐）：git filter-repo（需先安装：pip install git-filter-repo）</span></span>
<span class="line"><span class="token comment"># git filter-branch 已被官方标记为不推荐，filter-repo 更快更安全</span></span>
<span class="line"><span class="token function">git</span> filter-repo --invert-paths <span class="token parameter variable">--path</span> .env</span>
<span class="line"></span>
<span class="line"><span class="token comment"># 重新关联远程并强制推送（filter-repo 会清掉 origin，需要重新添加）</span></span>
<span class="line"><span class="token function">git</span> remote <span class="token function">add</span> origin git@github.com:username/repo.git</span>
...
<span class="line"></span>
<span class="line"><span class="token comment"># 方法二：使用 BFG Repo-Cleaner（更快，需要 Java 环境）</span></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="黄金法则" tabindex="-1"><a class="header-anchor" href="#黄金法则"><span>黄金法则</span></a></h3><ol><li><strong>频繁提交</strong>：小步快跑，每完成一个功能就提交</li><li><strong>写清楚提交信息</strong>：让别人（和未来的自己）能看懂</li><li><strong>推送前先拉取</strong>：避免冲突</li><li><strong>不要推送敏感信息</strong>：使用 <code>.gitignore</code></li><li><strong>谨慎使用 <code>--force</code></strong>：除非你知道自己在做什么</li><li><strong>善用分支</strong>：不要在 main 分支直接开发</li><li><strong>代码审查</strong>：使用 Pull Request 流程</li></ol><hr><p><strong>祝你使用 Git/GitHub 顺利！</strong> 遇到问题时，记住：<code>git help</code> 是你的好朋友。</p>`,216)])])}const r=n(l,[["render",p]]),o=JSON.parse('{"path":"/posts/GitHub%E6%96%B0%E6%89%8B%E5%AE%8C%E5%85%A8%E6%8C%87%E5%8D%97.html","title":"GitHub 新手完全指南","lang":"zh-CN","frontmatter":{"title":"GitHub 新手完全指南","date":"2025-11-20T00:00:00.000Z","categories":["开发工具"],"tags":["Git","GitHub"]},"git":{"updatedTime":1781360145000,"contributors":[{"name":"52nnnn","username":"52nnnn","email":"2764304248@qq.com","commits":5,"url":"https://github.com/52nnnn"},{"name":"Claude","username":"Claude","email":"noreply@anthropic.com","commits":4,"url":"https://github.com/Claude"}],"changelog":[{"hash":"61e1602c7ab5b8ecad136f49c743bdfbe872ea7e","time":1781360145000,"email":"2764304248@qq.com","author":"52nnnn","message":"docs: 全面检查并完善 26 篇学习笔记（纠错、补缺、扩充面试要点）"},{"hash":"aa91574c05586a9ad50920573505bd3b926a2363","time":1763876626000,"email":"2764304248@qq.com","author":"52nnnn","message":"fix: 为所有文档添加 frontmatter 格式","coAuthors":[{"name":"Claude","email":"noreply@anthropic.com"}]},{"hash":"6ed236e441ae5cfe1b0c306c713a231ed7ebc9fd","time":1763805959000,"email":"2764304248@qq.com","author":"52nnnn","message":"docs: 整合根目录文档到博客指南","coAuthors":[{"name":"Claude","email":"noreply@anthropic.com"}]},{"hash":"3ffb432574865b064ea9512c3a59862d91d39afb","time":1763183937000,"email":"2764304248@qq.com","author":"52nnnn","message":"feat: add comment component to all 12 articles","coAuthors":[{"name":"Claude","email":"noreply@anthropic.com"}]},{"hash":"da4a1f32e3b2d27eb28b30330c63b7481faef583","time":1763119350000,"email":"2764304248@qq.com","author":"52nnnn","message":"Initial commit: VuePress 2.0 博客项目搭建完成","coAuthors":[{"name":"Claude","email":"noreply@anthropic.com"}]}]},"filePathRelative":"posts/GitHub新手完全指南.md"}');export{r as comp,o as data};
